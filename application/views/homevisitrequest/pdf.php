   ...
   <body>
      ...
      <table style="font-size: 13px; margin-top: 230px;" cellpadding="3" border="1">
         <tbody>
            ...
            <tr>
               <td colspan="" width="175px" height="30px" style="font-size: 14px; ">
               <?php 
               ...
               <td colspan="" width="289px" height="30px" style="font-size: 14px; ">
               <?php 
               ...
               <td colspan="" width="100px" height="30px">
               <?php
               if($rvr_reason_for_visit == 'Discharged from Hospital'){
            ...
            <tr>
               <td rowspan="1" width="240px" height="32px" valign="bottom" style="font-size: 14px; border:1px solid black; vertical-align: bottom;">
            ...
            <tr>
               <td colspan="" width="190px" height="30px" style="font-size: 14px; ">
               <?php 
               ...
               <td colspan="" width="285px" height="30px" valign="top" style="font-size: 14px; ">
               <?php 
